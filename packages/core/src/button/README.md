...
| --button-color-default            | _var(--text-color)_                      | -   |
| --button-background-color-default | _var(--white)_                           | -   |
| --button-border-color-default     | _var(--border-color)_                    | -   |
| --button-color-primary            | _var(--white)_                           | -   |
| --button-background-color-primary | _var(--primary-color)_                   | -   |
| --button-border-color-primary     | _var(--button-background-color-primary)_ | -   |
| --button-color-info               | _var(--white)_                           | -   |
| --button-background-color-info    | _var(--info-color)_                      | -   |
| --button-border-color-info        | _var(--button-background-color-info)_    | -   |
| --button-color-success            | _var(--white)_                           | -   |
| --button-background-color-success | _var(--success-color)_                   | -   |
| --button-border-color-success     | _var(--button-background-color-success)_ | -   |
| --button-color-warning            | _var(--white)_                           | -   |
| --button-background-color-warning | _var(--warning-color)_                   | -   |
| --button-border-color-warning     | _var(--button-background-color-warning)_ | -   |
| --button-color-danger             | _var(--white)_                           | -   |
| --button-background-color-danger  | _var(--danger-color)_                    | -   |
| --button-border-color-danger      | _var(--button-background-color-danger)_  | -   |
